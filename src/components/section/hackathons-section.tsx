        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          <div className="flex items-center w-full">
            ...
            <div className="border bg-primary z-10 rounded-xl px-4 py-1">
              <span className="text-background text-sm font-medium">Projects Timeline</span>
            </div>
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              A chronological timeline of my projects and development journey. From full-stack web applications and complex system design to utility scripts and APIs, here is the history of what I've built.
            </p>
          </div>
        </div>
        <Timeline>
